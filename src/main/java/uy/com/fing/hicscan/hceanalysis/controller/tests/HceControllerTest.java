...
public class HceControllerTest {
    ...
    @PostMapping(value = "/process", consumes = "application/xml")
    public ResponseEntity<String> processXml(@RequestBody String xmlContent) throws IOException {
        ...
        try {
            ...
            // Ejecuta el use case
            try {
                Map<String, String> res = processHceUseCase.obtenerMedicamentosHCE(tempFile);

...
public class GestionDocumentosHCE {
    ...
    public GestionDocumentosHCE() {
        ...
        try {
            String xml = new String(getClass().getResourceAsStream("/HCE_Cargadas/JuanaPerez.xml").readAllBytes(), StandardCharsets.UTF_8);
            ...
            String xml3 = new String(getClass().getResourceAsStream("/HCE_Cargadas/MartinaFernandez.xml").readAllBytes(), StandardCharsets.UTF_8);
